...
// 	console.log(`Seconds passed in the current minute: ${secondsInMinute}`);
	...
	<circle cx="50" cy="50" r="18" fill="none" stroke="#666" stroke-width="7.5" filter="url(#blur2)" />
	<use href="#trackHour" stroke="tan" stroke-width="10" stroke-dasharray="4.71305416667" stroke-dashoffset="2.35652708333" />
	<circle cx="50" cy="50" r="15.5" fill="none" stroke="lightgray" />
	<circle cx="50" cy="50" r="20.5" fill="none" stroke="lightgray" />
	<g id="boxCar1H">
		<rect height="8" width="14" x="-7" y="-4" rx="1" fill="rgb(255, 107, 50)" />
		<rect height="5" width="10" x="-5" y="-2.5" rx="0.6" fill="rgba(0,0,0,0.2)" />
